...
<body font-size:15px; ">
            ...
            <select style="" class="form-control" name="state" id="countySel" required="true">
            <option value="country" disabled selected required>Country</option>
            </select> 

            <select class="form-control" name="countrya" id="stateSel" onchange="getSelectValue();" required>
            <option value="" selected="selected" disabled selected required>State</option>
            </select> 

            <select class="form-control" name="district" id="districtSel" required>
            <option value="" selected="selected" disabled selected required>City</option>
            </select>
</body>
</html>